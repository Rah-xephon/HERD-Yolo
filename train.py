...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'HybridResDenseNet(SNN).yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / '/sdata_2/yzsnn/trash_dataset/trash_dataset.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--save-period', type=int, default=25, help='Save checkpoint every x epochs (disabled if < 1)')
